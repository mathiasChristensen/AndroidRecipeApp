...
public class CardNameDateAdapter extends RecyclerView.Adapter<CardNameDateAdapter.ViewHolder> {
    ...
    public CardNameDateAdapter(String[] textArray1, String[] textArray2){
    ...
    @Override
    public CardNameDateAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //viewgroup is the recycler itself

        //creating the views
        CardView cv = (CardView) LayoutInflater.from(parent.getContext())
                //specifying the layout to use -> card_image2
                .inflate(R.layout.card_image2, parent, false);
